...
$AzureDevOpsPAT = "c4ss7grsgujs7247knm675jokwav5f3dhbknkhtu55ichjw63bba" #read-only token - will not make changes
...
# Make the REST API call to update the work item
    try {
        ...
        Write-Host $("Cannot update Work item '" + $workItemId + "': " + $_)
    }
